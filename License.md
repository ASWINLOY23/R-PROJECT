...
Permission is NOT granted to use, copy, modify, merge, publish, distribute, sublicense, sell, commercially exploit, or create derivative works from this software or any portion of it without explicit written permission from the author.
